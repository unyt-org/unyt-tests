...
export class UnytTests {
    ...
    static readonly SUCCESSFUL: unique symbol = Symbol("successful");
    static readonly PENDING: unique symbol = Symbol("pending");
    static readonly NO_PARAMS: unique symbol = Symbol("no params");
    ...
    static #tests = new Map<string, (Map<string, any[][]|typeof UnytTests.NO_PARAMS>)>() // contains test functions with different parameters for each test class/group
    static #test_case_results = new Map<string, (Map<string, (typeof UnytTests.SUCCESSFUL|typeof UnytTests.PENDING|any)[]>)>() // contains test results for each test case
    static #test_results = new Map<string, (Map<string, (typeof UnytTests.SUCCESSFUL|typeof UnytTests.PENDING|any)>)>() // contains test results for each test case
    static #test_group_results = new Map<string, (typeof UnytTests.SUCCESSFUL|typeof UnytTests.PENDING|any)>() // contains test results for each test case
    ...
    static getTests(group_name:string): Map<string, any[][]|typeof UnytTests.NO_PARAMS>{
        return this.#tests.get(group_name);
    }

    static getTestCases(group_name:string, test_name:string): any[][]|typeof UnytTests.NO_PARAMS{
    ...
    static async runTests(group_name:string, update_recursive_from_buttom = true) {
        let promises = [];
    ...
    static async runTest(group_name:string, test_name:string, update_recursive_from_buttom = true) {
        let promises = [];
        let index = 0;
    ...
    static async runTestCase(group_name:string, test_name:string, parameters:any[], index:number, update_recursive_from_buttom = true) {        
    ...
    static onAllTestsResult(listener:(result:typeof UnytTests.SUCCESSFUL|any)=>void) {
